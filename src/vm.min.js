...
function cmp(op, a, b) {
switch (op) {
case 19: return bothNum(a, b) ? Number(a) === Number(b) : a === b;
case 20: return !(bothNum(a, b) ? Number(a) === Number(b) : a === b);
case 21: return bothNum(a, b) ? Number(a) < Number(b) : a < b;
case 22: return bothNum(a, b) ? Number(a) > Number(b) : a > b;
case 23: return bothNum(a, b) ? Number(a) <= Number(b) : a <= b;
case 24: return bothNum(a, b) ? Number(a) >= Number(b) : a >= b;
}
}
function run() {
...
var op = B[ip++];
switch (op) {
case 1: S.push(str()); break;
case 2: S.push(str()); break;
case 3: S.push(doc.querySelectorAll(S.pop())); break;
case 4: addClass(top(), str()); break;
case 5: removeClass(top(), str()); break;
case 6: toggleClass(top(), str()); break;
case 7: setText(S.pop(), str()); break;
case 8: bindEvent(S.pop(), str(), u16()); break;
case 9: ip = u16(); break;
case 10: return;
case 11: extractText(S.pop(), str()); break;
case 12: { var v = str(); S.push(st[v] === undefined ? "" : st[v]); break; }
case 13: { var b = S.pop(), a = S.pop(); S.push(a === b); break; }
case 14: { var t = u16(); if (!S.pop()) ip = t; break; }
case 15: { var v = str(); st[v] = S.pop(); break; }
case 16: { var v = str(); if (!isNum(st[v])) throw new Error("NonNumeric");
var nv = Number(st[v]) + 1; if (!isFinite(nv)) throw new Error("NonNumeric");
st[v] = numToStr(nv); break; }
...
S.push(numToStr(diff)); break; }
case 19: case 20: case 21: case 22: case 23: case 24:
{ var b = S.pop(), a = S.pop(); S.push(cmp(op, a, b)); break; }
case 25: { var t = u16(); if (S.pop()) ip = t; break; }
case 26: { var n = S.pop(); setText(n, S.pop()); break; }
case 27: { var v = str(); var n = S.pop(); st[v] = n.length ? n[0].value : ""; break; }
